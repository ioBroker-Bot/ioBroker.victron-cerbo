...
### Adapter-Specific Context: Victron Cerbo GX MQTT Integration

This is an ioBroker adapter for Victron Cerbo GX devices that enables MQTT communication between ioBroker and Victron Energy systems.

**Key Features:**
- MQTT client implementation for Victron Cerbo GX devices
- Automatic device discovery and state mapping
- Support for solar chargers, battery monitors, inverters, and more
- Dynamic datapoint creation from MQTT messages
